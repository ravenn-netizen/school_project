...
def createTableStudent():
    cmd= "USE SCHOOL"
    cursor.execute(cmd)
    cmd="CREATE TABLE STUDENT(STUDENT_ID VARCHAR(6) PRIMARY KEY, NAME VARCHAR(30), DOB DATE, GENDER CHAR(1), AGE INT, GRADE INT, SECTION CHAR(1), STREAM VARCHAR(10), TRANSPORT VARCHAR(10), BUS_NO INT, BUS_STOP VARCHAR(20), GUARDIAN VARCHAR(40), TEL CHAR(8), EMAIL VARCHAR(20), ADDRESS VARCHAR(60) , CPR VARCHAR(9), PASSWORD VARCHAR(30)"
    cursor.execute(cmd)
