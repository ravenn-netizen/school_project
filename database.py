...
def createTableStudent():
    cmd="CREATE TABLE STUDENT(STUDENTID INT PRIMARY KEY, NAME VARCHAR(30), GENDER CHAR(1), CLASS INT, SECTION CHAR(1), STREAM VARCHAR(10), TRANSPORT VARCHAR(10), BUS_NO INT, BUS_STOP VARCHAR(20), GUARDIAN VARCHAR(40), TEL INT, EMAIL VARCHAR(20), PO_BOX INT, ADDRESS DICT, CPR INT)"
    cursor.execute(cmd)
